...
TEST_F(RpcTest, Ping) {
  ...
  auto method = "ping";
  auto request = std::make_unique<Request>(std::make_shared<hbase::test::pb::EmptyRequestProto>(),
                                           std::make_shared<hbase::test::pb::EmptyResponseProto>(), method);
  ...
  client
      ...
      .then([&](std::unique_ptr<Response> response) {
        auto pb_resp = std::static_pointer_cast<hbase::test::pb::EmptyResponseProto>(response->resp_msg());
...
TEST_F(RpcTest, Echo) {
  ...
  auto request = std::make_unique<Request>(std::make_shared<hbase::test::pb::EchoRequestProto>(),
                                           std::make_shared<hbase::test::pb::EchoResponseProto>(), method);
  auto pb_msg = std::static_pointer_cast<hbase::test::pb::EchoRequestProto>(request->req_msg());
  ...
  client
      ->AsyncCall(server_addr->getAddressStr(), server_addr->getPort(), std::move(request),
                  hbase::security::User::defaultUser())
      .then([&](std::unique_ptr<Response> response) {
        auto pb_resp = std::static_pointer_cast<hbase::test::pb::EchoResponseProto>(response->resp_msg());
        EXPECT_TRUE(pb_resp != nullptr);
...
TEST_F(RpcTest, Pause) {
  ...
  auto method = "pause";
  auto request = std::make_unique<Request>(std::make_shared<hbase::test::pb::PauseRequestProto>(),
                                           std::make_shared<hbase::test::pb::EmptyResponseProto>(), method);
  auto pb_msg = std::static_pointer_cast<hbase::test::pb::PauseRequestProto>(request->req_msg());
